...
@dataclass
class DataCollatorForWikiSectionFullDoc:
    tokenizer: PreTrainedTokenizerBase
    # padding: Union[bool, str, PaddingStrategy] = True
    # max_length: Optional[int] = None
    # pad_to_multiple_of: Optional[int] = None
    ...
    def __call__(self, features: List[InputDataClass]) -> Dict[str, torch.Tensor]:
        ...
        input_ids, labels, raw_text = zip(*features)
...
@dataclass
class DataCollatorForWikiSectionSplitBySection:
    tokenizer: PreTrainedTokenizerBase
    # padding: Union[bool, str, PaddingStrategy] = True
    # max_length: Optional[int] = None
    # pad_to_multiple_of: Optional[int] = None
...
@dataclass
class DataCollatorForWikisectionClassification:
    """
    Data collator that will dynamically pad the inputs received, as well as the labels.
