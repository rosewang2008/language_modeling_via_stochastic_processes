...
def simulate_brownian_motion(B_0, B_T, num_samples, sentence_lengths, dt=0.05, mu=0.0, sigma=1.0):
    """Run bridge motion from B_0"""
...
def main():
    ...
    for  _ in tqdm.tqdm(range(num_intervals)):
        ...
        bridge_feats = simulate_brownian_motion(
