...
from transformers import (
    ...
    set_seed,
    StoriesClassificationDataset,
    RecipeClassificationDataset,
    WikihowClassificationDataset,
...
def get_dataset(
    ...
    if 'stories' in args.dataset_name:
        dataset = StoriesClassificationDataset(
            tokenizer=tokenizer,
            file_path=file_path,
            block_size=512 # args.block_size
        ...
        dataset = WikihowClassificationDataset(
            tokenizer=tokenizer,
            file_path=file_path,
            block_size=512,  # args.block_size
        ...
        dataset = RecipeClassificationDataset(
            tokenizer=tokenizer,
            file_path=file_path,
            block_size=512, # args.block_size
            special_words=special_words
...
def main():
    ...
    SECTION_IDS, SPECIAL_TOKENS, tokenizer = get_special_tokens(
        data_args.dataset_name, tokenizer, add_tokens=True
    )
